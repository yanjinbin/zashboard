<template>
  <a
    ...
    class="text-base-content hover:text-primary hidden min-w-0 items-center justify-center gap-1.5 text-sm font-semibold whitespace-nowrap transition-colors lg:flex"
  >
    <img
