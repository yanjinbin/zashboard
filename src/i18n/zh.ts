...
const zh: LANG_MESSAGE = {
  ...
  fullRefreshProxiesUpdating: '代理订阅 {done}/{total}',
  fullRefreshRulesUpdating: '规则集 {done}/{total}',
  fullRefreshProxiesDone: '代理订阅 {success}/{total} 更新完成',
  fullRefreshProxiesPartial: '代理订阅 {success}/{total} 完成，失败: {failed}',
  fullRefreshRulesDone: '规则集 {success}/{total} 更新完成',
  fullRefreshRulesPartial: '规则集 {success}/{total} 完成，失败: {failed}',
  fullRefreshReloadDone: '配置已重载',
  fullRefreshReloadFailed: '配置重载失败',
  fullRefreshCacheDone: '缓存已清空',
  ipCheckTools: 'IP 检测工具',
  IPInfoAPI: 'IP信息API',
  IPInfoAPITip:
